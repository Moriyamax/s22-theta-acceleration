...
g=17 における naive/s22 の速度比

7.注意事項

naive g=17 は計算量が大きいため、通常は外挿推定になります

s22 g=17 は常に実測されます

このコードは、N=2 超重力のアトラクター方程式と
GL(4) Hitchin 系の幾何構造の数値的関係を調べる過程で作成されたものです
